...
List<String> testCases = [
  "one1two2three3", // Repeated Number Words
  "aftoneight", // Number Words as Substrings
  "sevenabc2", // Number Words at the Start or End
  "fourfive", // Lines Without Numeric Digits
  "oneeleven", // Overlapping Number Words
  "3abcxyz9", // Non-Numeric Characters Between Numbers
  //"", // Empty String
  //"abcxyz" // Non-Standard Line (No Numbers)
];
...
void main() {
  ...
  for (String word in input) {
    print("word = $word");
    for (int i = 0; i < 10; i++) {
      word = word.replaceAll(words[i], words[i] + i.toString() + words[i]);
    }
    print("Replaced all the letters, now it is $word");
    String begin =
        (word.codeUnits.firstWhere((e) => e >= 48 && e <= 57) - 48).toString();
    String end =
        (word.codeUnits.lastWhere((e) => e >= 48 && e <= 57) - 48).toString();
    solution += int.parse(begin + end);
    print("begin: $begin, end: $end, solution += ${int.parse(begin + end)}");
  }
